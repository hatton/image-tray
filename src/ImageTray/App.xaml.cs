...
public partial class App : Application
{
    ...
    private static void ReportOtherBuild(RunningBuild other)
    {
        ...
        MessageBox.Show(
            "A different build of Image Tray is already running, so this one has not started.\n\n" +
    ...
    {
        AutoStartService.ClearLegacyEntry();
    ...
    private bool ConfirmBulkRotation(string folder, int count)
    {
        ...
        var message =
            $"Image Tray keeps the newest {keep} images in:\n\n{folder}\n\n" +
        ...
        var answer = owner is null
            ? MessageBox.Show(message, "Image Tray", MessageBoxButton.YesNo, MessageBoxImage.Question)
            : MessageBox.Show(owner, message, "Image Tray", MessageBoxButton.YesNo, MessageBoxImage.Question);
    ...
    private void CreateTrayIcon()
    {
        ...
        menu.Items.Add(BuildMenuItem("Show Image Tray", ShowWindow));
        ...
        menu.Items.Add(BuildMenuItem("Exit Image Tray", QuitApp));

        _trayIcon = new TaskbarIcon
        {
            IconSource = LoadTrayIcon(),
            ToolTipText = "Image Tray — click to see your recent images",
